...
const AdminDirect = () => {
  ...
  const isSpecificAdmin = user?.id === '130f849a-d894-4ce6-a78e-0df3812093de';

  useEffect(() => {
    if (!isSpecificAdmin) {
      navigate("/");
    }
  }, [isSpecificAdmin, navigate]);
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-foreground mb-4">غير مصرح لك بالوصول</h1>
          <p className="text-muted-foreground mb-6">هذه الصفحة مخصصة للمدير فقط</p>
